...
let planetFacts = {
  ...
  //{yearMarsDiscovered:1846. yearMarsDiscovered: 1659}
...
let [raindrops, whiskers, ...aFewOfMyFavoriteThings] = [
  ...
  console.log(aFewOfMyFavoriteThings); // ['Bright copper kettles','warn woolen mittens', 'Brown paper packages tied up with strings']
